export const coursesData = {
  discover: {
    ...
    specs: [
      ...
      { 
        label: '준비물', 
        value: '수영복, 타올, 선크림, 액체형 멀미약, 기타 개인 준비물' 
      },
      { 
        label: '포함사항', 
  ...
  instructor: {
    ...
    title: '프로다이빙 [강사]',
    intro: [
      { text: '카이다이브의 강사 개발 코스는 스쿠버다이빙 강사 양성 과정으로 강사 후보생의 능력을 최대한 향상시키고 다이빙의 철학 및 교육시스템의 지도 능력을 트레이닝 받음으로써 강사로서의 태도와 전문성을 배우는 다이빙 교육자 과정입니다.\n' },
  ...
  assistant: {
    ...
    title: '프로다이빙 [보조강사]',
    intro: [
      { text: '프로다이버의 첫걸음인 보조강사 자격을 취득하게 되면 고유 회원번호를 발급받고 프로 다이버로서의 자격을 갖출 수 있습니다.\n' },
      { text: '프로 다이버로서 에티켓과 시범 가능한 수준의 스킬을 익히며 다이빙 물리학, 생리학, 환경, 장비에 관하여 배우게 됩니다.\n' },
    ...
    schedules: [
      {
        day: '나이트록스',
        items: [
          '나이트록스 프로그램을 이수하시면 학생들에게 산소의 함유를 40%까지 증가시킨 혼합 공기를 안전하게 계획하고 다이빙하는 방법을 가르칠 수 있습니다.',
